...
const solicitudesFiltradas = computed(() => {
    return store.solicitudes.filter(sol => {
        ...
        switch (sortBy.value) {
            case 'codigo':
                valA = getCodigoTramite(a);
                valB = getCodigoTramite(b);
                break;
            case 'fecha':
        ...
        <div id="solicitudes" class="print:hidden">
            ...
            <div class="mb-6 bg-card-main rounded-2xl border border-main p-4 shadow-sm">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div v-if="mostrarFiltros" class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 pt-4 border-t border-sec animate-prime-in">
                        <!-- Select: Distrito -->
