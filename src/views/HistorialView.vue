        ...
        <div id="solicitudes" class="print:hidden">
            ...
            <div class="mb-6 bg-card-main rounded-[2rem] border border-main p-6 shadow-sm">
                <div class="flex justify-between items-center mb-5">
                    ...
                    <button @click="limpiarFiltros" class="bg-accent hover:bg-accent-hover text-[color:var(--text-on-accent)] px-4 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-accent/20 transition-all flex items-center gap-2 cursor-pointer active:scale-95">
