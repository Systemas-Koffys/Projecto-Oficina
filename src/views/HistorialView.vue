...
<template>
    <div class="historial-view p-6 space-y-6 text-main animate-fade-in">
        ...
        <div v-if="solicitudSeleccionada" class="fixed inset-0 bg-gray-950/75 backdrop-blur-md flex items-center justify-center p-4 z-50 print:absolute print:inset-auto print:block print:bg-white print:p-0 print:m-0 print:overflow-visible animate-prime-in">
                ...
                <div class="hidden print:block print-header">
                    <div class="print-institution flex items-center gap-6 border-b-2 border-black pb-4 mb-4">
                        ...
                        <div class="print-institution-text flex-1 text-center">
                            ...
                            <p class="print-sec font-bold text-sm">DIRECCIÓN DE OBRAS PÚBLICAS MUNICIPALES DE TARIJA</p>
                            <p class="print-unit text-sm font-medium">Unidad de Mantenimiento de Ornato Público • Área de Arboricultura</p>
                        </div>
                    </div>
