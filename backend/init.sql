...
('Alto Senac', 13), ('Senac', 13), ('Tabladita I', 13), ('Tabladita II', 13), ('Mendez Arcos', 13), ('Palmas de Guadalupe', 13);
...
('2026-01-20', '20 de Enero', NULL, NULL, '#f59e0b'),
('2026-01-27', 'La Torre', NULL, NULL, '#8b5cf6'),
('2026-02-11', 'Lourdes', NULL, NULL, '#f59e0b'),
('2026-02-23', 'Juan Nicolay', NULL, NULL, '#ec4899'),
('2026-03-19', '19 de Marzo', NULL, NULL, '#f59e0b'),
('2026-03-19', 'San Jose', NULL, NULL, '#f59e0b'),
('2026-03-23', 'Eduardo Avaroa', NULL, NULL, '#f59e0b'),
('2026-03-25', 'La Pampa', NULL, NULL, '#3b82f6'),
('2026-03-31', 'Las Pascuas', NULL, NULL, '#f59e0b'),
('2026-04-15', 'Guadalquivir', NULL, NULL, '#8b5cf6'),
('2026-04-15', 'Libertad', NULL, NULL, '#8b5cf6'),
('2026-04-15', 'Los Chapacos', NULL, NULL, '#f59e0b'),
('2026-04-15', 'Andaluz', NULL, NULL, '#ec4899'),
('2026-04-15', '15 de Abril', NULL, NULL, '#ec4899'),
('2026-04-16', 'Aniceto Arce', NULL, NULL, '#ec4899'),
('2026-04-23', 'San Jorge 1', NULL, NULL, '#ec4899'),
('2026-04-23', 'San Jorge 2', NULL, NULL, '#ec4899'),
('2026-04-25', 'San Marcos', NULL, NULL, '#f59e0b'),
('2026-04-26', 'Constructor', NULL, NULL, '#ec4899'),
('2026-05-02', '02 de Mayo', NULL, NULL, '#ec4899'),
('2026-05-03', '3 de Mayo', NULL, NULL, '#f59e0b'),
('2026-05-11', 'Luis Espinal', NULL, NULL, '#ec4899'),
('2026-05-13', 'Virgen de Fatima', NULL, NULL, '#8b5cf6'),
('2026-05-13', 'Juan Pablo II', NULL, NULL, '#8b5cf6'),
('2026-05-19', 'German Busch', NULL, NULL, '#6366f1'),
('2026-05-25', 'Mendez Arcos', NULL, NULL, '#6366f1'),
('2026-05-26', 'San Martin', NULL, NULL, '#6366f1'),
('2026-05-27', 'IV Centenario', NULL, NULL, '#f59e0b'),
('2026-05-27', 'La Florida', NULL, NULL, '#f59e0b'),
('2026-06-04', 'Los Laureles', NULL, NULL, '#f59e0b'),
('2026-06-11', 'Pedro Antonio Flores', NULL, NULL, '#ec4899'),
('2026-06-13', 'San Antonio', NULL, NULL, '#6366f1'),
('2026-06-14', 'Defensores del Chaco', NULL, NULL, '#f59e0b'),
('2026-06-15', '15 de Junio', NULL, NULL, '#f59e0b'),
('2026-06-21', 'San Luis', NULL, NULL, '#6366f1'),
('2026-06-24', 'La Loma', NULL, NULL, '#8b5cf6'),
('2026-06-27', 'Aeropuerto', NULL, NULL, '#ec4899'),
('2026-06-29', 'San Pedro', NULL, NULL, '#ec4899'),
('2026-07-04', '4 de Julio', NULL, NULL, '#f59e0b'),
('2026-07-16', 'El Carmen', NULL, NULL, '#8b5cf6'),
('2026-07-16', 'Lindo San Geronimo', NULL, NULL, '#6366f1'),
('2026-07-22', 'Municipal', NULL, NULL, '#f59e0b'),
('2026-07-25', 'La Terminal', NULL, NULL, '#6366f1'),
('2026-07-25', 'Morros Blancos', NULL, NULL, '#ec4899'),
('2026-07-30', 'Catedral', NULL, NULL, '#6366f1'),
('2026-07-31', 'Paraiso', NULL, NULL, '#8b5cf6'),
('2026-08-05', 'La Huerta', NULL, NULL, '#f59e0b'),
('2026-08-06', '6 de Agosto', NULL, NULL, '#ec4899'),
('2026-08-15', 'Virgen de Chaguaya', NULL, NULL, '#8b5cf6'),
('2026-08-15', '15 de Agosto', NULL, NULL, '#8b5cf6'),
('2026-08-16', 'San Roque', NULL, NULL, '#10b981'),
('2026-08-17', 'Tabladita I', NULL, NULL, '#6366f1'),
('2026-08-17', 'Tabladita II', NULL, NULL, '#6366f1'),
('2026-08-18', 'Nueva Esperanza', NULL, NULL, '#f59e0b'),
('2026-08-20', 'San Bernardo', NULL, NULL, '#ec4899'),
('2026-08-25', 'Bartolome Atard', NULL, NULL, '#ec4899'),
('2026-08-25', 'Miraflores', NULL, NULL, '#6366f1'),
('2026-09-05', 'Los Alamos', NULL, NULL, '#8b5cf6'),
('2026-09-06', 'Oscar Alfaro', NULL, NULL, '#f59e0b'),
('2026-09-07', '7 de Septimbre', NULL, NULL, '#ec4899'),
('2026-09-10', 'Los Olivos', NULL, NULL, '#8b5cf6'),
('2026-09-11', 'Rosedal', NULL, NULL, '#ec4899'),
('2026-09-15', 'Luis Pizarro', NULL, NULL, '#8b5cf6'),
('2026-09-30', 'San Geronimo Centro', NULL, NULL, '#6366f1'),
('2026-10-01', 'El Tejar', NULL, NULL, '#6366f1'),
('2026-10-03', 'Salamanca', NULL, NULL, '#ec4899'),
('2026-10-05', 'Senac', NULL, NULL, '#6366f1'),
('2026-10-10', 'Moto Mendez', NULL, NULL, '#ec4899'),
('2026-10-12', '12 de Octubre', NULL, NULL, '#f59e0b'),
('2026-10-16', 'El Molino', NULL, NULL, '#10b981'),
('2026-10-20', '101 Familias', NULL, NULL, '#f59e0b'),
('2026-10-22', 'Luis de Fuentes', NULL, NULL, '#6366f1'),
('2026-10-26', 'Narciso Campero', NULL, NULL, '#ec4899'),
('2026-11-12', 'Carlos Wagnner', NULL, NULL, '#8b5cf6'),
('2026-11-13', 'Las Panosas', NULL, NULL, '#3b82f6'),
('2026-11-15', '15 de Noviembre', NULL, NULL, '#8b5cf6'),
('2026-11-25', 'Juan XXIII', NULL, NULL, '#ec4899'),
('2026-12-03', 'La Union', NULL, NULL, '#8b5cf6'),
('2026-12-10', '57 Viviendas', NULL, NULL, '#8b5cf6'),
('2026-12-12', 'Panamericano', NULL, NULL, '#8b5cf6'),
('2026-12-13', 'Palmas De Guadalupe', NULL, NULL, '#6366f1'),
